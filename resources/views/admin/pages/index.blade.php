...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-file"></i> Páginas</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Páginas</h3>
                                @can('Criar Páginas')
                                    <a href="{{ route('admin.pages.create') }}" title="Nova Página" class="btn btn-success"><i
                                            class="fas fa-fw fa-plus"></i>Nova Página</a>
                                @endcan
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Título', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/pages'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'title', 'name' => 'title'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
