...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-fw fa-cogs"></i> Configurações do Site</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex flex-wrap justify-content-between col-12 align-content-center">
                                <h3 class="card-title align-self-center">Configurações do Site</h3>
                                @can('Criar Configurações do Site')
                                    <a href="{{ route('admin.settings.create') }}" title="Nova Configuração"
                                        class="btn btn-success"><i class="fas fa-fw fa-plus"></i>Nova Configuração</a>
                                @endcan
                            </div>
                        </div>

                        @php
                            $heads = [['label' => 'ID', 'width' => 10], 'Nome', 'Conteúdo', ['label' => 'Ações', 'no-export' => true, 'width' => 10]];
                            $config = [
                                'ajax' => url('/admin/settings'),
                                'columns' => [['data' => 'id', 'name' => 'id'], ['data' => 'name', 'name' => 'name'], ['data' => 'content', 'name' => 'content'], ['data' => 'action', 'name' => 'action', 'orderable' => false, 'searchable' => false]],
